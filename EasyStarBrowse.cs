...
namespace EasyStarBrowse
{
    [BepInPlugin("GniMaerd.DSP.plugin.EasyStarBrowse", "EasyStarBrowse", "1.0")]
    public class EasyStarBrowse:BaseUnityPlugin
    {
        ...
        void Start()
        {
            ...
            Harmony.CreateAndPatchAll(typeof(EasyStarBrowse));
        }
        void Update()
        {
